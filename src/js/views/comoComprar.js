		...
		<div className="">
			<div className="container-fluid blue-bg d-flex justify-content-center align-items-center mt-n5">
				<div className="container">
					<h1 className="pt-2 text-center titulo">
			...
			{/* <div id="timeline">
				<h1 classNameName="text-white">
					<strong>¿Cómo comprar?</strong>
				</h1>
				<p classNameName="leader">
					All cards must be the same height and width for space calculations on large screens.
				</p>
				<div classNameName="demo-card-wrapper">
					<div classNameName="demo-card demo-card--step1 rounded">
						<div classNameName="head">
							<div classNameName="number-box">
								<span>01</span>
							</div>
							<h2>
								<span classNameName="small">Subtitle</span> Technology
							</h2>
						</div>
					...
					<div classNameName="demo-card demo-card--step2">
						<div classNameName="head">
							<div classNameName="number-box">
								<span>02</span>
							</div>
							<h2>
								<span classNameName="small">Subtitle</span> Confidence
							</h2>
						</div>
						<div classNameName="body">
							<p>
					...
					<div classNameName="demo-card demo-card--step3">
						<div classNameName="head">
							<div classNameName="number-box">
								<span>03</span>
							</div>
							<h2>
								<span classNameName="small">Subtitle</span> Adaptation
							</h2>
						</div>
						<div classNameName="body">
							<p>
					...
					<div classNameName="demo-card demo-card--step4">
						<div classNameName="head">
							<div classNameName="number-box">
								<span>04</span>
							</div>
							<h2>
								<span classNameName="small">Subtitle</span> Consistency
							</h2>
						</div>
						<div classNameName="body">
							<p>
					...
					<div classNameName="demo-card demo-card--step5">
						<div classNameName="head">
							<div classNameName="number-box">
								<span>05</span>
							</div>
							<h2>
								<span classNameName="small">Subtitle</span> Conversion
							</h2>
						</div>
						<div classNameName="body">
							<p>
