		...
		<div className="container d-flex justify-content-center align-items-center">
			<div id="contenedorSomos " className="">
				...
				<p>
					...
					que se adaptan a lo digital y los que no. Ya no es el consumidor el que busca a los negocios, son
					los negocios los que tienen que buscar a sus consumidores, y la clave para ésta busqueda es el mundo
					digital
				</p>
				<p>
